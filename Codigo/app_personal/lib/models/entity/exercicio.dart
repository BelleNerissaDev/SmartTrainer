...
class Exercicio {
  ...
  set gruposMusculares(List<GrupoMuscular> gruposMusculares) =>
      _gruposMusculares = gruposMusculares;
  ...
  set intervalo(String intervalo) => _intervalo = intervalo;
  ...
  static Exercicio fromMap(
    ...
    return Exercicio(
      ...
      imagem: map['imagem'],
      gruposMusculares: map['gruposMusculares'],
    );
  }
}
